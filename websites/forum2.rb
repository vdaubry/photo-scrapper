...
class Forum2 < BaseWebsite
  ...
  def host_urls(post_page)
    ...
    links = doc.xpath('//div[contains(@class, "post-body")]//a[child::img[contains(@src, "jpg") or contains(@src, "jpeg")]]')
  ...
  def direct_urls(post_page)
    ...
    doc.xpath('//div[contains(@class, "post-body")]//img[not(parent::a) and contains(@src, "jpg") or contains(@src, "jpeg")]').map{|i| i[:src]}
