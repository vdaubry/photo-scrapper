  ...
  describe "unit tests", :local => :true do
    ...
    describe "single_photo_links", :vcr => true do
      it "finds single images" do
        single_photo_links = @tumblr12.single_photo_links
        single_photo_links.count.should == 49

        expected_url = YAML.load_file('spec/websites/tumblr/tumblr_test_conf.yml')["tumblr12"]["single_photo_links"]["image_source"]
    ...
    describe "photoset_links", :vcr => true do
      it "finds images inside photoset" do
        photoset_links = @tumblr12.photoset_links
